...
BLOG_AUTHOR = "Tom Kealy"  # (translatable)
BLOG_TITLE = "DataTom"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://TomKealy.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://TomKealy.github.io/"
BLOG_EMAIL = "tom.kealy.tk@gamil.com"
BLOG_DESCRIPTION = "Data Blog"  # (translatable)

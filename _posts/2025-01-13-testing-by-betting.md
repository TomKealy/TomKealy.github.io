...
If $E$ happens, I have multiplied the \$1 I risked by $\frac{1}/{\alpha}$. This makes standard testing a special case of testing by betting, the special case where the bet is all-or-nothing. In return for USD 1, I get either $\$\frac{1}/\alpha}$ or $0.
